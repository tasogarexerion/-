...
CP_ALPHA_MIN = float(os.environ.get("TASO_CP_ALPHA_MIN", "0.22"))
CP_ALPHA_MAX = float(os.environ.get("TASO_CP_ALPHA_MAX", "0.95"))
CP_SPREAD_REF = float(os.environ.get("TASO_CP_SPREAD_REF", "300"))
...
# --- ゲームフェイズ（手数非依存） ---
GP_EWMA_ALPHA = float(os.environ.get("TASO_GP_EWMA_ALPHA", "0.35"))
GP_HYS_GAP    = float(os.environ.get("TASO_GP_HYS_GAP", "0.08"))
...
# --- 形勢（stance） ---
STANCE_EWMA_ALPHA = float(os.environ.get("TASO_STANCE_EWMA_ALPHA", "0.25"))
STANCE_TREND_ALPHA = float(os.environ.get("TASO_STANCE_TREND_ALPHA", "0.25"))

TREND_DEADZONE = int(os.environ.get("TASO_TREND_DEADZONE", "30"))
